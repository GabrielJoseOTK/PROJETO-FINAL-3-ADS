...
FOR EACH ROW
BEGIN
	update presenca set frequencia=0 where id_aluno=new.id;
END $
DELIMITER ;
...
select alterar_faltas(1,4403,10);
...
insert into aluno(id, nome, senha, email) values( 1001, 'gabri', 123, 'teste@testa');
insert into aluno(id, nome, senha, email) values( 1002, 'gab', 13, 'teste@tes.com');
...
insert into presenca values(1001,4403,8);
insert into presenca values(1001,5567,5);
